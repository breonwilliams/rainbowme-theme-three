...
function show_wp_change_email_details_options() {
    $wp_change_email_details_version = "1.1";
    ...
    ?>
    <h2>WP Change Email Details Settings v <?php echo $wp_change_email_details_version; ?></h2>

    <p>For information, updates and detailed documentation, please visit the <a href="https://www.tipsandtricks-hq.com/wordpress-plugin-change-wp-email-from-details-1883" target="_blank">plugin homepage</a></p>
...
<form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
    ...
    echo '
	<div class="postbox">
	<h3><label for="title">Email Details Customization Settings</label></h3>
	<div class="inside">';
...
function wp_change_email_details_options() {
    echo '<div class="wrap"><h2>WP Change Email Details Options</h2>';
...
function wp_change_email_details_options_page() {
    add_options_page('Change Email Details', 'Change Email Details', 'manage_options', __FILE__, 'wp_change_email_details_options');
}
